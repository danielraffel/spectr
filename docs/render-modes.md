...
The bottom-right mode chip shows **MIXING** or **TRACKING** and the current
...
**OVER** stays lit after an overload until you click the readout to clear it.
Hover over the readout for the reset hint and the largest recorded overload.
