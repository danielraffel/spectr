...
| MOD-2 | Whole-bank, Snapshot A/B, and Morph targets | Implemented | Native target-mask bridge now composes selected Bank/A/B/Morph destinations; focused mask unit coverage added; exact-SDK/audio proof remains pending | Pending audible check in new PKG | Waiting automated proof + human confirmation |
