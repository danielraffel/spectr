...
| DEL-2 | Spectr PR merged with required checks green | Spectr branch remains clean; Pulp modulation successor is pushed as PR #8028 at exact head `f2a04d1dcd5adf2ff9019bf750b74fb983456dca` | Build and baseline-diff are green; required macOS job `100444687696` failed before tests on Homebrew proxy CONNECT abort (curl 56 / HTTP 000), while Linux/coverage/universal lanes remain pending | Not applicable | Open |
