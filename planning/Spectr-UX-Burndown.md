...
| DEL-3 | Logic AUv2 and REAPER VST3/CLAP acceptance | Formats implemented; installed baseline AU is `/Library/Audio/Plug-Ins/Components/Spectr.component` (`aufx/Spec/Pulp`) | Read-only `auval -v aufx Spec Pulp` passes; this is the prior installed component, not the new dual-LFO package. Logic and REAPER receipts remain pending | Pending | Open |
