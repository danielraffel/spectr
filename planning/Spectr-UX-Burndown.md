...
| DEL-4 | Signed, notarized, installed, launch-verified M5 PKG | Exact-head four-payload Release build completed against official Pulp v0.829.0 SDK (`cc75fa91cf6942a197b2fb00b38ac679de3cbcd1`) | `artifacts/Spectr-1.0.0.pkg` SHA-256 `6548042453e420e0d8cfc7d8b9283dfa3d962905668f809d82dce924aee0bf83`; Apple notarization submission `1f9c7e28-6b7c-4991-98be-9eabacc2fd4f` accepted; `spctl` and `pkgutil --check-signature` pass | Install and launch confirmation still pending (non-interactive sudo unavailable) | Waiting human/host confirmation |
