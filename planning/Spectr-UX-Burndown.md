...
| DEL-3 | Logic AUv2 and REAPER VST3/CLAP acceptance | Formats implemented; installed baseline AU is `/Library/Audio/Plug-Ins/Components/Spectr.component` (`aufx/Spec/Pulp`) | Fresh exact-head CLAP bundle passes `clap-validator` (21 tests, 16 passed, 0 failed, 5 skipped) after fixing Viewport Width text parsing; installed AU `auval` baseline passes. Logic and REAPER receipts remain pending | Pending install and host confirmation | Open |
| DEL-4 | Signed, notarized, installed, launch-verified M5 PKG | Exact-current-head (`302b265`) four-payload Release build completed against official Pulp v0.829.0 SDK (`cc75fa91cf6942a197b2fb00b38ac679de3cbcd1`) | `artifacts/Spectr-1.0.2.pkg` SHA-256 `97becdb35be6787c12f2bbdcae919ebf0781bddd56182f3f275ea556928cfe94`; Apple notarization submission `ebdc0763-75dd-415f-b30b-307121e2911a` accepted; staple, `spctl`, and installer signature validation pass | Install and launch confirmation still pending (non-interactive sudo unavailable) | Waiting human/host confirmation |
